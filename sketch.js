...
bg_img2 = loadImage("village1.jpg");
welcome = loadImage("welcome image.png");
...
function draw(){
  if(gamestate == 0)
  {
    image(welcome,0,0,displayWidth,displayHeight);
